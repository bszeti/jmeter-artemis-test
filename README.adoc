...
* Openwire client: _activemq-client-all-x.z.y.jar_
...
* Documentation: http://activemq.apache.org/components/artemis/documentation/latest/using-jms.html
* Source: https://github.com/apache/activemq-artemis/blob/master/activemq-client/src/main/java/org/apache/activemq/jndi/ActiveMQInitialContextFactory.java
