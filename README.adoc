...
// export JMETER_OPTS='-Djava.naming.provider.url=/Users/bszeti/projects/UPSFreight/git/jmeter-artemis-test/jndi.properties -Djava.naming.factory.initial=org.apache.qpid.jms.jndi.JmsInitialContextFactory'
